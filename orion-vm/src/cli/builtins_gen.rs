...
pub fn generated_modules(v: &mut Vec<BuiltinDoc>) {
    ...
    v.push(f("browser", "dblclick", "browser.dblclick(…)", "Función del módulo browser."));
    v.push(f("browser", "rightclick", "browser.rightclick(…)", "Función del módulo browser."));
    v.push(f("browser", "hover", "browser.hover(…)", "Función del módulo browser."));
    v.push(f("browser", "drag", "browser.drag(…)", "Función del módulo browser."));
    ...
    v.push(f("browser", "texts", "browser.texts(…)", "Función del módulo browser."));
    v.push(f("browser", "exists", "browser.exists(…)", "Función del módulo browser."));
